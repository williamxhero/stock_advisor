...
class CognitiveRouter:
    ...
    def candidate(self, stage: str, packet: dict[str, Any], requested_timeout: int, search: bool) -> RoutingDecision | None:
        ...
        if profile.major and profile.deadline_seconds >= 240:
            return RoutingDecision(os.environ.get("STOCK_ADVISOR_CODEX_JUDGMENT_MODEL", "gpt-5.6-sol"), "xhigh", search, profile.deadline_seconds, "重大事件或明显证据冲突，候选使用 Sol XHigh 并保留 Medium 回退")
