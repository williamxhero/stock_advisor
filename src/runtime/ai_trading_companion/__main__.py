...
def _m1_research_as_of(evidence: dict[str, Any], frozen_as_of: str | None) -> str:
    """M1 judges the exact frozen M0 market/fact clock.

    Source acquisition timestamps may naturally be a few seconds later.  The
    M1 packet validator treats those separately from future market facts.
    """
