...
POLICY={
 "daily_open_close":{"logs/05_DECISION_LOG.csv","logs/12_OPPORTUNITY_LOG.csv","state/10_THEME_STATE.csv","state/11_STOCK_STATE.csv"},
 "daily_intraday":{"logs/05_DECISION_LOG.csv","state/10_THEME_STATE.csv","state/11_STOCK_STATE.csv"},
 "periodic_review":{"logs/05_DECISION_LOG.csv","logs/12_OPPORTUNITY_LOG.csv"},
}
