...
TASK_POLICIES = {
    ...
    "daily.execution.1430": TaskPolicy("daily.execution.1430", "A股 14:30尾盘研判", "daily_execution", time(15, 20), _RESERVE, _INTRADAY, _INTRADAY, timedelta(minutes=15), "daily_intraday"),
