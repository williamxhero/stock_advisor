...
from ai_trading_companion.web_access_gateway import WebAccessGatewayError
...
class LocalResearchTests(unittest.TestCase):
    ...
    def test_planner_is_strict_and_names_gateway_only(self) -> None:
        ...
        planner = BrokerResearchPlanner(broker, deadline=lambda: 123.0)
    ...
    def test_persistent_gateway_failure_becomes_explicit_awg_stage_failure(self) -> None:
        ...
        def unavailable(*_args):
            raise WebAccessGatewayError("sanitized", category="AWG_OUTAGE", attempts=3)
